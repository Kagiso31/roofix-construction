...
const Hero = () => {
  return (
    <section>
      <div className="relative text-white h-[20.375rem] bg-hero-banner bg-no-repeat bg-cover before:absolute before:inset-0 before:bg-black before:opacity-60">
          ...
          <div className=" flex flex-col justify-center gap-2 font-semibold text-center h-full sm:text-left">
            ...
            <nav>
              <div className="space-x-2">
                ...
                <span>—</span>
                <NavLink
                  to="/roofix-construction/about"
                  className="transition-all duration-500 ease-in-out hover:text-accent"
                >
                  About
                </NavLink>
                <span>—</span>
                <NavLink>Team Member</NavLink>
              </div>
            </nav>
          </div>
        </div>
